...
Adobe Connect ضبط‌ها را به صورت استریم‌های FLV جداگانه (اشتراک صفحه، دوربین، VoIP) به همراه یک تایم‌لاین XML ذخیره می‌کند. این اسکریپت با تجزیه تایم‌لاین، ضبط کامل را بازسازی و تمام استریم‌ها را در یک فایل خروجی ترکیب می‌کند.
